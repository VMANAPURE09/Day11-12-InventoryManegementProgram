...
namespace CommercialDataProcessing
{
    ...
    {
        private static string path = @"E:\BridgeLabz2\PraticeProblem\Day11-12-InventoryManegementProgram\CommercialDataProcessing\CommercialDataProcessing\Account.json";
